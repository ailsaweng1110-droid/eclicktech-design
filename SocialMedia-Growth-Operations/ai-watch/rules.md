...
> 公众号面向中国读者，海外英文源是"原料"不是"成品"。每期内容必须做本地化处理。

### A. 选题红线（绝对不写）

| 类别 | 关键词举例 |
|---|---|
| 涉政 | 中美关系对抗性叙事、领导人言论评价、地缘政治冲突 |
| 涉党 | 任何对中国政党的描述与评价 |
| 涉台 / 港 / 藏 / 疆 | 主权 / 历史 / 民族 / 宗教类讨论 |
| 涉宗教族裔 | 伊斯兰、犹太、新疆棉花等敏感族群叙事 |
| 涉色情暴力 | 战争、犯罪、性内容 |
| 涉绕审 / 翻墙 | VPN / proxy / 科学上网 / 绕过审查 |
| 涉版权破解 | 盗版、破解工具、数据爬取灰产 |
| 涉股票 / 币圈 | 投资荐股、币圈热度、ICO、Meme 币 |

> 海外创始人涉政言论可保留"商业判断"部分，删掉"政治判断"部分。

### B. 翻译与本地化处理

| 场景 | 处理 |
|---|---|
| 美元金额 | 括号备注 ≈ 人民币（按 ¥7/USD 折算）|
...
| 栏目 | 中国本土最低占比 | 推荐主体 |
|---|---|---|
| 01 AI 模型 / 产品动态 | **≥ 1 条** | DeepSeek、智谱、Kimi（Moonshot）、阿里通义、字节豆包、腾讯混元、百川、零一万物、MiniMax 等 |
| 02 AI + 设计 | 可选 | 即创、Mastergo、墨刀、稿定、剪映、稿定 PRO、Soulgen 等国产工具 |
| 03 AI + 海外营销 | **≥ 1 条** | TikTok、SHEIN、Temu、米哈游、CapCut、Lark、出海游戏、出海 SaaS、出海 AI 工具 |
| 04 创始人观点 | 可选 | 陆奇、王慧文、张一鸣、朱啸虎、傅盛、王小川、李开复、孙正义等公开发言 |

> 当周如果实在抓不到中国相关内容，必须主动用 `WebSearch site:36kr.com` 等指令补抓。

### D. 中文信息源（用 WebSearch + site: 抓取）

| 类型 | 站点 |
|---|---|
| 行业资讯 | `36kr.com`、`qbitai.com`（量子位）、`jiqizhixin.com`（机器之心）、`huxiu.com`（虎嗅）、`geekpark.net`（极客公园）、`tmtpost.com`（钛媒体） |
| 创投 / 出海 | `latepost.com`（晚点）、`founderpark.cn`、`itjuzi.com`（IT 桔子）、`waitanshijie.com`（远川研究所）、`youxituoluo.com`（游戏陀螺） |
| 内容生态 | `xiaohongshu.com` 热搜、`zhihu.com` 热榜、微博热搜 |
| 公众号搜索 | "拾象"、"海外独角兽"、"Founder Park"、"晚点 LatePost"、"远川研究所"（用 WebSearch 间接抓） |
